...
export default function SimProductCard({ product }) {
  ...
  return (
    <div className="p-2 shadow-md bg-white shadow-gray-500 rounded-lg ">
      <div className="flex  p-2 h-[180px] w-full">
        {" "}
        {/* Fixed height */}
        <Link
        ...
        >
          <div className="w-full h-[160px] overflow-hidden flex items-center justify-center bg-gray-200 rounded-lg p-2 shadow-sm">
            {" "}
        ...
        <div className="flex flex-col p-2 flex-grow w-[65%]">
          {" "}
          {/* Flex-grow ensures equal height for the content */}
          <div className="flex items-center justify-between">
            <p className="font-semibold text-[12px] lg:text-lg line-clamp-1 overflow-hidden mb-4 lg:mb-0">
              {product.name}
            </p>
            {isFavorite ? (
              <FaHeart
          ...
          <div className="h-[60px] overflow-hidden">
            ...
            <p className="text-sm h-full text-gray-600 line-clamp-3">
              {" "}
              {/* Limit lines */}
              {product.desc}
            </p>
